...
int main( int argc, char** argv )
{
    ...
    ofstream myfile;
    ofstream debugfile;
    myfile.open ("/home/vagrant/Results/traj_scania_1.txt");
    ...
    for(int numFrame=3; numFrame < MAX_FRAME; numFrame++)	
    {
        ...
        cout << " curr points before  " << " " << currFeatures.size() << endl;
        cout << " prev points before  " << " " << prevFeatures.size() << endl;
        
        reduceVector(prevFeatures, angle_status);
        reduceVector(currFeatures, angle_status);

        cout << " curr points after  " << " " << currFeatures.size() << endl;
        cout << " prev points after  " << " " << prevFeatures.size() << endl;
